      ...
      var he = s(53053),
        ...
        se = function (d) {
          ...
          return (0, e.jsxs)(Z.Z, {
            ...
            onFinish: d.onSubmit,
            children: [
              (0, e.jsxs)(Z.Z.StepForm, {
                initialValues: { name: d.values.name, desc: d.values.desc },
                title: t.formatMessage({
          ...
          var d = (0, M.useState)(!1),
            ...
            U = [
              ...
              },
              {
                ...
                dataIndex: 'updatedAt',
                valueType: 'dateTime',
                renderFormItem: function (l, n, m) {
                  var p = n.defaultRender,
                    c = (0, Y.Z)(n, ['defaultRender']),
                    O = m.getFieldValue('status');
                  return ''.concat(O) === '0'
                    ? !1
                    : ''.concat(O) === '3'
                    ? (0, e.jsx)(
                    ...
                    (0, e.jsxs)(
                      R.Z,
                      {
                        ...
                        children: [
                          (0, e.jsx)(K.Z, {}),
                          ' ',
                          (0, e.jsx)(r._H, { id: 'pages.searchTable.new', defaultMessage: 'New' }),
                        ],
                      },
                      'primary',
                    ),
                ...
                (0, e.jsxs)(Q.Z, {
                  extra: (0, e.jsxs)('div', {
                    children: [
                      ...
                      ' ',
                      (0, e.jsx)('a', { style: { fontWeight: 600 }, children: T.length }),
                      ' ',
                      (0, e.jsx)(r._H, { id: 'pages.searchTable.item', defaultMessage: '\u9879' }),
                      '\xA0\xA0',
                      (0, e.jsxs)('span', {
                        children: [
                          (0, e.jsx)(r._H, {
                          ...
                          return i().wrap(function (p) {
                            for (;;)
                              switch ((p.prev = p.next)) {
                                case 0:
                                  return (p.next = 2), ne(T);
                                case 2:
                                  $([]),
                                    (l = j.current) === null ||
                                      l === void 0 ||
                                      (n = l.reloadAndRest) === null ||
                                      n === void 0 ||
                                      n.call(l);
                                case 4:
                                case 'end':
                    ...
                    i().mark(function l(n) {
                      ...
                      return i().wrap(function (c) {
                        for (;;)
                          switch ((c.prev = c.next)) {
                            case 0:
                              return (c.next = 2), le(n);
                            case 2:
                              (m = c.sent),
                                m && (w(!1), y(void 0), j.current && j.current.reload());
                            case 4:
                            case 'end':
                              return c.stop();
                          }
              ...
              (0, e.jsx)(W.Z, {
                ...
                children:
                  ...
                  (0, e.jsx)(q.Z, {
                    ...
                    params: { id: f == null ? void 0 : f.name },
                    columns: U,
                  }),
              }),
            ],
